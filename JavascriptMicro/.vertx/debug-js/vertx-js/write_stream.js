...
var WriteStream = function(j_val, j_arg_0) {
  ...
  this.exceptionHandler =  function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_writeStream["exceptionHandler(io.vertx.core.Handler)"](__args[0] == null ? null : function(jVal) {
  ...
  this.write =  function() {
    ...
    if (__args.length === 1 && j_T.accept(__args[0])) {
      j_writeStream["write(java.lang.Object)"](j_T.unwrap(__args[0])) ;
      return that;
    } else if (__args.length === 2 && j_T.accept(__args[0]) && typeof __args[1] === 'function') {
      j_writeStream["write(java.lang.Object,io.vertx.core.Handler)"](j_T.unwrap(__args[0]), function(ar) {
        if (ar.succeeded()) {
          __args[1](null, null);
        } else {
  ...
  this.setWriteQueueMaxSize =  function(maxSize) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='number') {
      j_writeStream["setWriteQueueMaxSize(int)"](__args[0]) ;
      return that;
  ...
  this.drainHandler =  function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_writeStream["drainHandler(io.vertx.core.Handler)"](__args[0]) ;
      return that;
