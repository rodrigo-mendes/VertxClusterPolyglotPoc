...
var JFileSystemProps = Java.type('io.vertx.core.file.FileSystemProps');
...
var FileSystemProps = function(j_val) {
  ...
  var __super_totalSpace = this.totalSpace;
  var __super_unallocatedSpace = this.unallocatedSpace;
  var __super_usableSpace = this.usableSpace;
  /**
  ...
  this.totalSpace =  function() {
    ...
    } else if (typeof __super_totalSpace != 'undefined') {
      return __super_totalSpace.apply(this, __args);
    }
  ...
  this.unallocatedSpace =  function() {
    ...
    } else if (typeof __super_unallocatedSpace != 'undefined') {
      return __super_unallocatedSpace.apply(this, __args);
    }
    else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.usableSpace =  function() {
    ...
    } else if (typeof __super_usableSpace != 'undefined') {
      return __super_usableSpace.apply(this, __args);
    }
    else throw new TypeError('function invoked with invalid arguments');
  };
...
FileSystemProps._jtype = {accept: function(obj) {
...
FileSystemProps._create = function(jdel) {var obj = Object.create(FileSystemProps.prototype, {});
  FileSystemProps.apply(obj, arguments);
  return obj;
}
