...
var JLock = Java.type('io.vertx.core.shareddata.Lock');
...
var Lock = function(j_val) {
  ...
  var __super_release = this.release;
  /**
  ...
  this.release =  function() {
    ...
    if (__args.length === 0) {
      j_lock["release()"]();
    } else if (typeof __super_release != 'undefined') {
      return __super_release.apply(this, __args);
    }
...
Lock._jtype = {accept: function(obj) {
...
Lock._create = function(jdel) {var obj = Object.create(Lock.prototype, {});
  Lock.apply(obj, arguments);
  return obj;
}
module.exports = Lock;